...
const Environment: React.FC<EnvironmentProps> = ({ scene }) => {
  useEffect(() => {
    // Ajout de lumières
    ...
    return () => {
      // Supprimer les objets de la scène si nécessaire
    };
  }, [scene]);

  return null; // Ce composant ne rend rien directement dans le DOM
};
